		...
		if($this->input->post('login'))
		{
			...
			if($this->form_validation->run())
			{
				...
				try {				
					...
					//$user_name = ucfirst($user_name);	//IMPORTANTE: QUITAR COMENTARIO ANTES DE IR A PRODUCCIÓN, esta funcion da problemas y hace que luego de que el usuario no exista al cambiar la primera letra por mayuscula (la tabla anonima para las pruebas esta en minusculas)
